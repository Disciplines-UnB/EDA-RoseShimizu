/*
João é um matemático e programador que adora subtrações numéricas. Certo dia, João encontrou um livro com o título
“O Número 91”. Conforme lê-se no livro:
...
João não deu atenção para o livro, já que não acredita em maldições e coisas do tipo. Passados alguns dias, João quis
escrever um programa que sempre fizesse a subtração de qualquer número dado em 10.
Você deve modificar o programa de João, adicionando a maldição a seguir para que ele aprenda a não mais abrir livros
estranhos que encontrar por aí.
Maldição:
